        ...
        <div className="relative p-8 lg:p-10">
          ...
          <div className="mt-7 flex flex-wrap items-center gap-4">
            ...
            <button
              ...
              className={`flex items-center gap-2 rounded-full px-6 py-3.5 text-sm font-semibold uppercase tracking-[0.14em] transition-all duration-300 ${
                agregado
                  ? "bg-oro-400 text-vino-950"
                  : "bg-oro-500 text-vino-950 shadow-lg shadow-oro-500/25 hover:-translate-y-0.5 hover:bg-oro-400"
              }`}
            >
