...
export function IconoOrdenar({ className = "" }: IconProps) {
  return (
    <svg {...base} className={className}>
...
export function IconoCorazon({ className = "" }: IconProps) {
  return (
    <svg {...base} className={className}>
...
export function IconoCorazonFill({ className = "" }: IconProps) {
  return (
...
export function IconoUsuario({ className = "" }: IconProps) {
  return (
    <svg {...base} className={className}>
...
export function IconoGoogle({ className = "" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="currentColor">
...
export function IconoApple({ className = "" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="currentColor">
